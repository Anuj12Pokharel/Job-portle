    ...
    <div className="bg-white shadow-sm">
      <nav className="mx-auto  px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          {/* Right: Auth Buttons */}
          <div className=" text-2xl hidden md:flex items-center space-x-1 ">
            <a
              href="#"
              className=" text-3xl  py-2 text-gray-700 hover:text-gray-900 text-sm font-medium transition-colors duration-200"
            >
              For Jobsekeers
            </a>
            <a
              href="#"
              className="  py-2 text-gray-700 hover:text-gray-900 text-sm font-medium transition-colors duration-200"
            >
              For Employers
            </a>
          </div>
