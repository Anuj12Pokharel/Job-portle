...
export default function NavigationHeader() {
  ...
  return (
    <div className="bg-white shadow-sm">
      ...
      <nav className=" mx-auto px-4 sm:px-6 lg:px-5">
        <div className="flex justify-between items-center h0">
        
 
  <div className="flex-shrink-0">
    <div className="w-[45px] h-[45px] rounded-full overflow-hidden border border-gray-200">
