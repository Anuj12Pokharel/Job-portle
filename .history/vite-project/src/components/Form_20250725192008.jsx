...
export default function TalentNetworkForm({ formData, onInputChange, selectedFile, onFileChange, isSubmitting, onSubmit }) {
  return (
    <form onSubmit={onSubmit} className="bg-white rounded-lg shadow-lg overflow-hidden">
      ...
      <div className="p-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            <label htmlFor="designation" className="block text-sm font-medium text-gray-700">Current/Last Designation *</label>
            <div className="relative">
          ...
          {/* Field of Expertise */}
          <div className="space-y-2">
            <label htmlFor="fieldOfExpertise" className="block text-sm font-medium text-gray-700">Field of Expertise *</label>
            <select
              id="fieldOfExpertise"
              value={formData.fieldOfExpertise}
              onChange={(e) => onInputChange("fieldOfExpertise", e.target.value)}
            ...
            <div className="flex flex-col space-y-2">
              <label className="inline-flex items-center">
                <input
                  ...
                  onChange={() => onInputChange("employmentStatus", "still-working")}
                  required
                />
              ...
              <label className="inline-flex items-center">
                <input
                  ...
                  onChange={() => onInputChange("employmentStatus", "actively-seeking")}
                />
        ...
        <div className="mt-8 space-y-4">
          <label className="block text-sm font-medium text-gray-700">Upload Your Updated CV *</label>
