  ...
  return (
    <section className="relative py-20  bg-gradient-to-br from-blue-500/5 via-gray-50 to-purple-500/5 lg:py-32">
      ...
      style={{backgroundImage:`url(${training})`}}
       className="absolute inset-0 bg-contain bg-center opacity-5"></div>
...
<p className="text-xl md:text-2xl text-cyan-500 mb-8 leading-relaxed">
  Upgrade Your Skills Today
          ...
          <p className="text-lg text-foreground/80 max-w-3xl mx-auto mb-10 leading-relaxed">
            At JobLink360, we offer a wide selection of professional training programs across Nepal designed to boost
            your skills and career potential. Whether you're just starting out or looking to advance in your field, our
            expert trainers are here to guide you every step of the way. Your desire to learn, combined with our
            commitment to quality education, creates the perfect path to career success.
          </p>
