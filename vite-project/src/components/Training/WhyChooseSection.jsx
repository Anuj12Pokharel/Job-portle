...
const features = [
  {
    ...
    description: "Get equipped with practical, job-ready skills aligned with today's industry needs.",
  },
  {
    icon: Users,
    title: "Learn from Industry Experts",
    description: "Train under professionals who bring real-world insights and experience to the classroom.",
  },
  {
    icon: HandHeart,
  ...
  },
  {
    ...
    description: "Choose from a variety of courses designed to suit your career aspirations and learning level.",
  },
  {
    icon: Network,
    title: "Grow Your Network",
    description: "Meet fellow learners, share ideas, and create lasting professional connections.",
  },
];
        ...
        <div className="max-w-8xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-black max-w-2xl mx-auto">
              Discover what makes our training programs stand out and how we help you achieve your career goals.
            </p>
          </div>
