...
const trainingPrograms = [
  {
    ...
    rating: 4.9,
    category: "Marketing",
    description: "Master SEO, social media, content marketing, and analytics to drive business growth.",
  },
  {
    id: 2,
    ...
    rating: 4.8,
    category: "Technology",
    description: "Learn React, Node.js, databases, and deployment to become a complete web developer.",
  },
  {
    id: 3,
    ...
    rating: 4.9,
    category: "Data",
    description: "Master Python, machine learning, and data visualization for data-driven decisions.",
  },
  {
    id: 4,
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-8xl mx-auto">
          ...
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-cyan-500 to-teal-600 bg-clip-text text-transparent ">Training Gallery</h2>
          ...
          <div className="md:hidden relative">
            <div className="bg-white rounded-lg shadow overflow-hidden">
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-semibold mb-3">{trainingPrograms[currentIndex].title}</h3>
