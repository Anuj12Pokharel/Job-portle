  ...
  return (
    ...
    >
      ...
      <div className="relative container mx-auto text-center">
        ...
        >
          Career Tips, Job Search Guides & <span className="text-cyan-900 ">Blogs</span>
        </h1>

        {/* Supporting description */}
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          Stay updated with the latest insights, resume tips, interview advice, and 
          career development stories from industry experts and our job-seeking community.
        </p>
