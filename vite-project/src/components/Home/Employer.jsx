...
const features = [
  ...
  "Job openings are promoted across Joblink360’s social media channels to increase visibility and reach.",
    ...
    <section className="py-10 px-10 " ref={ref}>
      ...
      <div className="p-8 text-center">
        ...
        <p className="text-gray-600 mb-6 leading-relaxed">
         Get a qualified candidates and find the perfect match for your team.
        </p>
