   ...
   <div className=''>
           <div className="flex flex-col lg:flex-row items-center md:gap-8  p-8">
                   <div className="flex-1">
                     <h2 className="font-bold  text-teal-600 text-3xl">Strategic HR Consulting for Better Business Practices </h2>
                     <p className="text-black mt-2 text-justify">
                     Enhance your HR operations with guidance from our expert consultants. From improving workplace 
policies to boosting employee satisfaction, we help align your HR practices with your company’s goals.
                     </p>
                   </div>
