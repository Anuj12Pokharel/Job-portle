   ...
   <div className=''>
           <div className="flex flex-col lg:flex-row items-center md:gap-8  p-8">
                   <div className="flex-1">
                     <h2 className="font-bold  text-teal-600 text-3xl">Reliable Outsourcing for Better Productivity</h2>
                     <p className="text-black mt-2 text-justify">
                     Delegate time-consuming tasks to trusted professionals through our outsourcing services. Reduce your 
workload and operational stress while maintaining high-quality performance.
                     </p>
                   </div>
