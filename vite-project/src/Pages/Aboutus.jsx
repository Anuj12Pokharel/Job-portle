      ...
      <div className="flex flex-col lg:flex-row items-center gap-8 p-6 rounded-lg">
        ...
        <div className="flex-1 flex justify-center">
          <img
            src={Joblink}
            alt="Intro"
            className="rounded-lg shadow-md h-60  w-96"
          />
        </div>
      </div>

      {/* Mission */}
      <div className="flex flex-col lg:flex-row-reverse items-center gap-8 p-6 rounded-lg">
        <div className="flex-1 border-2 border-green-600 p-3">
          <h2 className="font-bold text-lg text-green-800">Our Mission</h2>
          <p className="text-gray-700 mt-2">
        ...
        <div className="flex-1 flex justify-center">
          <img
            src={mission}
            alt="Mission"
            className="rounded-lg shadow-md h-60 w-full"
          />
        </div>
      </div>
      ...
      <div className="flex flex-col lg:flex-row-reverse items-center gap-8 p-6 rounded-lg">
        <div className="flex-1 border-2 border-green-600 p-3">
          ...
          <ul className="list-disc pl-6 text-gray-700 mt-3 space-y-2">
            <li>
              <b>Recruitment and Staffing Services:</b>  Our comprehensive recruitment services are 
...
together with the right employers for long-term success.
            ...
            <li>
              <b>HR Outsourcing:</b>  Right from recruitment processes and induction to payroll 
...
your organization. 
            ...
            <li>
              <b>Training and Development:</b>  Our soft skills training is designed to strengthen 
...
adherence. 
            ...
            <li>
              <b>Job Posting Platform:</b> : Our job posting services allow employers to reach a wide range 
